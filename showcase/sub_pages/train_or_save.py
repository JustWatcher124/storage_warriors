...
try:
    ...
    with st.expander("Click here to train your model"):
        ...
        st.write(str(only_selected_models(selected_models)))
    st.markdown(markdown[2])
    with st.expander("Click here to save your data for later use"):
